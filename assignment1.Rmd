...
```{sql first exercise,code=readLines("01504786_Eli_Lauwers_1.sql"),connection=con,output.var="df1"}
...
```{sql second exercise,code=readLines("01504786_Eli_Lauwers_2.sql"),connection=con,output.var="df2"}
...
```{sql third exercise,code=readLines("01504786_Eli_Lauwers_3.sql"),connection=con,output.var="df3"}
...
```{sql fourth exercise,code=readLines("01504786_Eli_Lauwers_4.sql"),connection=con,output.var="df4"}
...
```{sql fifth exercise,code=readLines("01504786_Eli_Lauwers_5.sql"),connection=con,output.var="df5"}
